...
proc adi_project_create {project_name {mode 0}} {
  ...
  if {$mode == 0} {
    set project_system_dir "./vivado/$project_name.srcs/sources_1/bd/system"
    create_project $project_name vivado -part $p_device -force
  } else {
  ...
  if {$mode == 0} {
    ...
    write_hwdef -file "vivado/$project_name.data/$project_name.hwdef"
  }
}
...
proc adi_project_synth {project_name prcfg_name hdl_files {xdc_files ""}} {
  ...
  set p_prefix "vivado/$project_name.data/$project_name"
